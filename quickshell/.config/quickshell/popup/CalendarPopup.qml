...
PopupWindow {
  ...
  anchor.rect.x: triggerItem ? triggerItem.width - implicitWidth : 0
  anchor.rect.y: triggerItem ? triggerItem.height + 10 : 0
  color: "transparent"
  visible: showPopup || slideAnim.running
  implicitWidth: calBody.implicitWidth
  implicitHeight: calBody.implicitHeight
